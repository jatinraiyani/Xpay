...
<div class="container">
    <div class="errorpage">
        <div class="error">
            ...
            <h1 class="p" style="font-size: 45px">{{ __('error.SOMETHING WENT WRONG.') }}</h1>

            <div class="page-ms">
              <p class="page-msg">{{ __('error.Oops, the page you are looking for Disappeared') }}</p>
              <a href="#" onclick="window.history.back()" class="go-back">{{ __('error.Go Back') }}</a>
            </div>
        </div>
